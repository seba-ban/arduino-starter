...
- 1 × LED (any color)
- 1 × Resistor (220 ohm — the one with **red, red, brown** stripes)
- 2 × jumper wires
...
Try changing `delay(1000)` to `delay(200)` in the code and upload again.
What happens? Can you make it blink as fast as your heartbeat?
(Hint: a normal heartbeat is about 60–100 times per minute!)
